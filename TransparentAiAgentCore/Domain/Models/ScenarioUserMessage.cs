...
{
    /// <summary>
    /// Represents a user message originated by the application (e.g., from scenario playback).
    /// These messages simulate user input for teaching or demonstration purposes.
    /// </summary>
    public class ScenarioUserMessage : ApplicationMessage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScenarioUserMessage"/> class.
        /// </summary>
