...
/// <summary>
/// Accumulates streaming tool call updates from Azure OpenAI by index.
///
/// KEY INSIGHT: Azure OpenAI sends ToolCallId and FunctionName only in the FIRST chunk.
/// Subsequent chunks have ToolCallId=null and only use Index to identify which tool call to update.
///
/// This class fixes Bug #1 by matching tool call updates by Index, not by ID.
/// </summary>
public class AzureStreamingToolCallAccumulator
{
